...
class ArticleFragment : BaseFragment<ArticleViewModel>(), IArticleView {
    ...
    private  val commentsAdapter by lazy {
        CommentsAdapter{
            Log.e("Article Fragment", "click on comment: ${it.id} ${it.slug}")
    ...
    override fun setupViews() {
        ...
        val corenerRadius = root.dpToIntPx(8)
        ...
        Glide.with(root)
            .load(args.poster)
            .transform(CenterCrop(), RoundedCorners(corenerRadius))
            .into(iv_author_avatar)
    ...
    private fun setupCopyListener(){
        tv_text_content.setCopyListener { copy ->
            ...
            val clip = ClipData.newPlainText("Copied mode", copy)
